package ma.engflexy.alc.zynerator.security.jwt;
...
import ma.engflexy.alc.AlcApplication;
import ma.engflexy.alc.zynerator.security.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = AlcApplication.getCtx().getBean(UserService.class);
