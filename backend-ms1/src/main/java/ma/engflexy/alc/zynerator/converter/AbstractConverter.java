package ma.engflexy.alc.zynerator.converter;


import ma.engflexy.alc.zynerator.bean.Etablissement;
import ma.engflexy.alc.zynerator.dto.EtablissementDto;

import ma.engflexy.alc.zynerator.util.ListUtil;
import ma.engflexy.alc.zynerator.audit.AuditBusinessObject;
import ma.engflexy.alc.zynerator.bean.BusinessObject;
import ma.engflexy.alc.zynerator.dto.AuditBaseDto;
import ma.engflexy.alc.zynerator.dto.BaseDto;
import ma.engflexy.alc.zynerator.util.DateUtil;
import ma.engflexy.alc.zynerator.util.RefelexivityUtil;
import ma.engflexy.alc.zynerator.util.StringUtil;
import ma.engflexy.alc.zynerator.util.Utils;
