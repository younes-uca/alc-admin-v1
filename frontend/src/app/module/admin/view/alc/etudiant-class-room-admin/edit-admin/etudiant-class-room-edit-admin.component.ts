...
export class EtudiantClassRoomEditAdminComponent extends AbstractEditController<EtudiantClassRoomDto, EtudiantClassRoomCriteria, EtudiantClassRoomService>   implements OnInit {
